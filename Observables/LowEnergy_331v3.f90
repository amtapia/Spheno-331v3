...
Use StandardModel 
Use RunSM_331v3
Use FlavorKit_LFV_331v3
Use FlavorKit_QFV_331v3
Use FlavorKit_Observables_331v3
...
Subroutine Gminus2(Ifermion,MAh,MAh2,MFe,MFe2,Mhh,Mhh2,MHpm,MHpm2,MVZp,               & 
& MVZp2,cplcFeFeAhL,cplcFeFeAhR,cplAhhhVP,cplFeFv1cHpmL,cplFeFv1cHpmR,cplcFeFehhL,       & 
& cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZpL,cplcFeFeVZpR,cplcFv1FecHpmL,          & 
& cplcFv1FecHpmR,cplcFeFv1HpmL,cplcFeFv1HpmR,cplcFv1Fv1VPL,cplcFv1Fv1VPR,cplHpmcHpmVP,   & 
& cplcFecFv1HpmL,cplcFecFv1HpmR,a_mu)

Real(dp),Intent(in)  :: MAh(3),MAh2(3),MFe(3),MFe2(3),Mhh(3),Mhh2(3),MHpm(4),MHpm2(4),MVZp,MVZp2

Complex(dp),Intent(in)  :: cplcFeFeAhL(3,3,3),cplcFeFeAhR(3,3,3),cplAhhhVP(3,3),cplFeFv1cHpmL(3,3,4),            & 
& cplFeFv1cHpmR(3,3,4),cplcFeFehhL(3,3,3),cplcFeFehhR(3,3,3),cplcFeFeVPL(3,3),           & 
& cplcFeFeVPR(3,3),cplcFeFeVZpL(3,3),cplcFeFeVZpR(3,3),cplcFv1FecHpmL(3,3,4),            & 
& cplcFv1FecHpmR(3,3,4),cplcFeFv1HpmL(3,3,4),cplcFeFv1HpmR(3,3,4),cplcFv1Fv1VPL(3,3),    & 
& cplcFv1Fv1VPR(3,3),cplHpmcHpmVP(4,4),cplcFecFv1HpmL(3,3,4),cplcFecFv1HpmR(3,3,4)
...
coup1L = cplcFeFv1HpmL(gt1,i1,i2)
coup1R = cplcFeFv1HpmR(gt1,i1,i2)
coup2L = cplcFv1FecHpmL(i1,gt2,i3)
coup2R = cplcFv1FecHpmR(i1,gt2,i3)
...
Do i1= 3,4
  Do i2= 1,3
   i3 = i2
  If ((MHpm2(i1).gt.mz2).Or.(0._dp.gt.mz2).Or.(0._dp.gt.mz2)) Then
coup1L = cplcFecFv1HpmL(gt1,i2,i1)
coup1R = cplcFecFv1HpmR(gt1,i2,i1)
coup2L = cplFeFv1cHpmL(gt2,i3,i1)
coup2R = cplFeFv1cHpmR(gt2,i3,i1)
ratio = MHpm2(i1)/0._dp
 chargefactor = chargefactor*(0._dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
...
Do i1= 3,4
  Do i2= 1,3
   i3 = i2
  If ((MHpm2(i1).gt.mz2).Or.(0._dp.gt.mz2).Or.(0._dp.gt.mz2)) Then
coup1L = cplcFeFv1HpmL(gt1,i2,i1)
coup1R = cplcFeFv1HpmR(gt1,i2,i1)
coup2L = cplcFv1FecHpmL(i3,gt2,i1)
coup2R = cplcFv1FecHpmR(i3,gt2,i1)
ratio = MHpm2(i1)/0._dp
 chargefactor = chargefactor*(0._dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
a_mu = a_mu - chargefactor*(Real(coup1L*Conjg(coup1R),dp)*F3gamma(ratio)/0._dp& 
...
Do i1= 1,3
  Do i2= 3,4
   i3 = i2
  If ((0._dp.gt.mz2).Or.(MHpm2(i2).gt.mz2).Or.(MHpm2(i3).gt.mz2)) Then
coup1L = cplcFecFv1HpmL(gt1,i1,i2)
coup1R = cplcFecFv1HpmR(gt1,i1,i2)
coup2L = cplFeFv1cHpmL(gt2,i1,i3)
coup2R = cplFeFv1cHpmR(gt2,i1,i3)
ratio = MHpm2(i2)/0._dp
 chargefactor = chargefactor*(1._dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
a_mu = a_mu - chargefactor*(2._dp*Real(coup1L*Conjg(coup1R),dp)*F4(ratio)/0._dp& 
...
Subroutine LeptonEDM(Ifermion,MAh,MAh2,MFe,MFe2,Mhh,Mhh2,MHpm,MHpm2,MVWp,             & 
& MVWp2,MVZ,MVZ2,MVZp,MVZp2,cplcFeFeAhL,cplcFeFeAhR,cplAhhhVP,cplFeFv1cHpmL,             & 
& cplFeFv1cHpmR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFv1FeVWpL,           & 
& cplcFv1FeVWpR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFeVZpL,cplcFeFeVZpR,cplcFv1FecHpmL,        & 
& cplcFv1FecHpmR,cplcFeFv1HpmL,cplcFeFv1HpmR,cplcFv1Fv1VPL,cplcFv1Fv1VPR,cplcFeFv1cVWpL, & 
& cplcFeFv1cVWpR,cplHpmcHpmVP,cplcFecFv1HpmL,cplcFecFv1HpmR,cplcVWpVPVWp,EDM)

Implicit None
Real(dp),Intent(in)  :: MAh(3),MAh2(3),MFe(3),MFe2(3),Mhh(3),Mhh2(3),MHpm(4),MHpm2(4),MVWp,MVWp2,             & 
& MVZ,MVZ2,MVZp,MVZp2

Complex(dp),Intent(in)  :: cplcFeFeAhL(3,3,3),cplcFeFeAhR(3,3,3),cplAhhhVP(3,3),cplFeFv1cHpmL(3,3,4),            & 
& cplFeFv1cHpmR(3,3,4),cplcFeFehhL(3,3,3),cplcFeFehhR(3,3,3),cplcFeFeVPL(3,3),           & 
& cplcFeFeVPR(3,3),cplcFv1FeVWpL(3,3),cplcFv1FeVWpR(3,3),cplcFeFeVZL(3,3),               & 
& cplcFeFeVZR(3,3),cplcFeFeVZpL(3,3),cplcFeFeVZpR(3,3),cplcFv1FecHpmL(3,3,4),            & 
& cplcFv1FecHpmR(3,3,4),cplcFeFv1HpmL(3,3,4),cplcFeFv1HpmR(3,3,4),cplcFv1Fv1VPL(3,3),    & 
& cplcFv1Fv1VPR(3,3),cplcFeFv1cVWpL(3,3),cplcFeFv1cVWpR(3,3),cplHpmcHpmVP(4,4),          & 
& cplcFecFv1HpmL(3,3,4),cplcFecFv1HpmR(3,3,4),cplcVWpVPVWp
...
coup1L = cplcFeFv1cVWpL(gt1,i1)
coup1R = cplcFeFv1cVWpR(gt1,i1)
coup2L = cplcFv1FeVWpL(i1,gt2)
coup2R = cplcFv1FeVWpR(i1,gt2)
ratio = MVWp2/0._dp
 chargefactor = chargefactor*(1._dp)
 ratio = 1._dp/ratio ! conventions in 1402.7065 are different 
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
...
!ratio = 0._dp/MHpm2(i2)
 !If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
!EDM = EDM +(-1)* chargefactor*Aimag(coup1L*Conjg(coup1R))*FeynFunctionB(ratio)*0._dp/MHpm2(i2) 
!End if 
...
coup2L = cplFeFv1cHpmL(gt2,i3,i1)
coup2R = cplFeFv1cHpmR(gt2,i3,i1)
!ratio = 0._dp/MHpm2(i1)
 !If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
!EDM = EDM -(0)* chargefactor*Aimag(coup1R*Conjg(coup1L))*FeynFunctionA(ratio)*0._dp/MHpm2(i1) 
!End if 
...
chargefactor = 1 
  Do i2= 1,3
   i3 = i2
  If ((MVWp2.gt.mz2).Or.(0._dp.gt.mz2).Or.(0._dp.gt.mz2)) Then
coup1L = cplcFeFv1cVWpL(gt1,i2)
coup1R = cplcFeFv1cVWpR(gt1,i2)
coup2L = cplcFv1FeVWpL(i3,gt2)
coup2R = cplcFv1FeVWpR(i3,gt2)
ratio = MVWp2/0._dp
 ratio = 1._dp/ratio ! conventions in 1402.7065 are different 
 chargefactor = chargefactor*(0._dp)
 If ((ratio.eq.ratio).and.(ratio.lt.1.0E+30_dp).and.(ratio.gt.1.0E-30_dp)) Then 
...
Subroutine DeltaRho(MAh,MAh2,MDpm,MDpm2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,               & 
& Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhcVWpVWp,              & 
& cplAhAhVZVZ,cplAhcHpmcVWp,cplAhhhVZ,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucVWpL,             & 
& cplcFdFucVWpR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFv1cVWpL,cplcFeFv1cVWpR,cplcFuFuVZL,       & 
& cplcFuFuVZR,cplcFv1Fv1VZL,cplcFv1Fv1VZR,cplcgAgWpcVWp,cplcgWCgAcVWp,cplcgWCgWCVZ,      & 
& cplcgWCgZcVWp,cplcgWCgZpcVWp,cplcgWpgWpVZ,cplcgXp1gXp1VZ,cplcgXp2gXp2VZ,               & 
& cplcgZgWpcVWp,cplcgZpgWpcVWp,cplcHpmcVWpVP,cplcHpmcVWpVZ,cplcHpmcVWpVZp,               & 
...
& cplcVWpVWpVZpVZp3,cplcVWpVWpVZVZ1,cplcVWpVWpVZVZ2,cplcVWpVWpVZVZ3,cplcVXpVXpVZ,        & 
& cplcVXpVXpVZVZ1,cplcVXpVXpVZVZ2,cplcVXpVXpVZVZ3,cplDpmcDpmcVWpVWp,cplDpmcDpmVZ,        & 
& cplDpmcDpmVZVZ,cplDpmcHpmcVWp,cplDpmcVWpVXp,cplhhcHpmcVWp,cplhhcVWpVWp,cplhhhhcVWpVWp, & 
& cplhhhhVZVZ,cplhhVPVZ,cplhhVZVZ,cplhhVZVZp,cplHpmcHpmcVWpVWp,cplHpmcHpmVZ,             & 
& cplHpmcHpmVZVZ,cplHpmVWpVZ,cplHpmVXpVZ,rho)
...
Complex(dp),Intent(in)  :: cplAhAhcVWpVWp(3,3),cplAhAhVZVZ(3,3),cplAhcHpmcVWp(3,4),cplAhhhVZ(3,3),               & 
& cplcFdFdVZL(5,5),cplcFdFdVZR(5,5),cplcFdFucVWpL(5,4),cplcFdFucVWpR(5,4),               & 
& cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFeFv1cVWpL(3,3),cplcFeFv1cVWpR(3,3),             & 
& cplcFuFuVZL(4,4),cplcFuFuVZR(4,4),cplcFv1Fv1VZL(3,3),cplcFv1Fv1VZR(3,3),               & 
& cplcgAgWpcVWp,cplcgWCgAcVWp,cplcgWCgWCVZ,cplcgWCgZcVWp,cplcgWCgZpcVWp,cplcgWpgWpVZ,    & 
& cplcgXp1gXp1VZ,cplcgXp2gXp2VZ,cplcgZgWpcVWp,cplcgZpgWpcVWp,cplcHpmcVWpVP(4),           & 
& cplcHpmcVWpVZ(4),cplcHpmcVWpVZp(4),cplcVWpcVWpVWpVWp1,cplcVWpcVWpVWpVWp2,              & 
...
& cplcVWpVWpVZVZ2,cplcVWpVWpVZVZ3,cplcVXpVXpVZ,cplcVXpVXpVZVZ1,cplcVXpVXpVZVZ2,          & 
& cplcVXpVXpVZVZ3,cplDpmcDpmcVWpVWp(2,2),cplDpmcDpmVZ(2,2),cplDpmcDpmVZVZ(2,2),          & 
& cplDpmcHpmcVWp(2,4),cplDpmcVWpVXp(2),cplhhcHpmcVWp(3,4),cplhhcVWpVWp(3),               & 
& cplhhhhcVWpVWp(3,3),cplhhhhVZVZ(3,3),cplhhVPVZ(3),cplhhVZVZ(3),cplhhVZVZp(3),          & 
& cplHpmcHpmcVWpVWp(4,4),cplHpmcHpmVZ(4,4),cplHpmcHpmVZVZ(4,4),cplHpmVWpVZ(4),           & 
& cplHpmVXpVZ(4)
...
Call Pi1LoopVZ(0._dp,Mhh,Mhh2,MAh,MAh2,MDpm,MDpm2,MFd,MFd2,MFe,MFe2,MFu,              & 
& MFu2,MVZ,MVZ2,MVZp,MVZp2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,cplAhhhVZ,cplDpmcDpmVZ,      & 
...
Subroutine STUparameter(vSM,g1SM,g2SM,g3SM,YuSM,YdSM,YeSM,MAh,MAh2,MDpm,              & 
& MDpm2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,            & 
& MVZ,MVZ2,MVZp,MVZp2,cplAhhhVP,cplDpmcDpmVP,cplcFdFdVPL,cplcFdFdVPR,cplcFeFeVPL,        & 
...
& cplcVWpVWpVZVZ3,cplcVXpVXpVZVZ1,cplcVXpVXpVZVZ2,cplcVXpVXpVZVZ3,cplHpmVWpVZp,          & 
& cplcVWpVWpVZp,cplcVWpVWpVZpVZp1,cplcVWpVWpVZpVZp2,cplcVWpVWpVZpVZp3,cplAhcHpmcVWp,     & 
& cplDpmcHpmcVWp,cplDpmcVWpVXp,cplcFdFucVWpL,cplcFdFucVWpR,cplcFeFv1cVWpL,               & 
& cplcFeFv1cVWpR,cplcgWCgAcVWp,cplcgAgWpcVWp,cplcgZgWpcVWp,cplcgZpgWpcVWp,               & 
& cplcgWCgZcVWp,cplcgWCgZpcVWp,cplhhcHpmcVWp,cplhhcVWpVWp,cplcHpmcVWpVP,cplcHpmcVWpVZ,   & 
& cplcHpmcVWpVZp,cplAhAhcVWpVWp,cplDpmcDpmcVWpVWp,cplhhhhcVWpVWp,cplHpmcHpmcVWpVWp,      & 
& cplcVWpcVWpVWpVWp1,cplcVWpcVWpVWpVWp2,cplcVWpcVWpVWpVWp3,cplcVWpcVXpVWpVXp1,           & 
& cplcVWpcVXpVWpVXp2,cplcVWpcVXpVWpVXp3,cplcHpmcVXpVP,cplcDpmcVXpVWp,cplcHpmcVXpVZ,      & 
& cplAhAhVPVZ,cplDpmcDpmVPVZ,cplhhhhVPVZ,cplHpmcHpmVPVZ,cplcVWpVPVWpVZ1,cplcVWpVPVWpVZ2, & 
& cplcVWpVPVWpVZ3,cplcVXpVPVXpVZ1,cplcVXpVPVXpVZ2,cplcVXpVPVXpVZ3,cplAhAhVPVZp,          & 
& cplDpmcDpmVPVZp,cplhhhhVPVZp,cplHpmcHpmVPVZp,cplcVWpVPVWpVZp1,cplcVWpVPVWpVZp2,        & 
& cplcVWpVPVWpVZp3,cplcVXpVPVXpVZp1,cplcVXpVPVXpVZp2,cplcVXpVPVXpVZp3,cplAhAhVZVZp,      & 
& cplDpmcDpmVZVZp,cplhhhhVZVZp,cplHpmcHpmVZVZp,cplcVWpVWpVZVZp1,cplcVWpVWpVZVZp2,        & 
& cplcVWpVWpVZVZp3,cplcVXpVXpVZVZp1,cplcVXpVXpVZVZp2,cplcVXpVXpVZVZp3,cplAhHpmVWp,       & 
& cplcFuFdVWpL,cplcFuFdVWpR,cplhhHpmVWp,cplHpmcHpmcVXpVWp,Spar,Tpar,Upar)
...
Call Pi1LoopVZ(MVZ2,Mhh,Mhh2,MAh,MAh2,MDpm,MDpm2,MFd,MFd2,MFe,MFe2,MFu,               & 
& MFu2,MVZ,MVZ2,MVZp,MVZp2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,cplAhhhVZ,cplDpmcDpmVZ,      & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFeFeVZL,cplcFeFeVZR,cplcFuFuVZL,cplcFuFuVZR,               & 
& cplcFv1Fv1VZL,cplcFv1Fv1VZR,cplcgWpgWpVZ,cplcgWCgWCVZ,cplcgXp1gXp1VZ,cplcgXp2gXp2VZ,   & 
& cplhhVPVZ,cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVZ,cplHpmVWpVZ,cplHpmVXpVZ,cplcVWpVWpVZ,      & 
...
Call Pi1LoopVWp(MVWp2,MHpm,MHpm2,MAh,MAh2,MDpm,MDpm2,MVXp,MVXp2,MFd,MFd2,             & 
& MFu,MFu2,MFe,MFe2,Mhh,Mhh2,MVWp,MVWp2,MVZ,MVZ2,MVZp,MVZp2,cplAhcHpmcVWp,               & 
& cplDpmcHpmcVWp,cplDpmcVWpVXp,cplcFdFucVWpL,cplcFdFucVWpR,cplcFeFv1cVWpL,               & 
& cplcFeFv1cVWpR,cplcgWCgAcVWp,cplcgAgWpcVWp,cplcgZgWpcVWp,cplcgZpgWpcVWp,               & 
& cplcgWCgZcVWp,cplcgWCgZpcVWp,cplhhcHpmcVWp,cplhhcVWpVWp,cplcHpmcVWpVP,cplcVWpVPVWp,    & 
...
Call Pi1LoopVPVZ(MVZ2,MAh,MAh2,MDpm,MDpm2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,             & 
& Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhVPVZ,cplAhhhVP,       & 
& cplAhhhVZ,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFeFeVPL,cplcFeFeVPR,     & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,               & 
& cplcFv1Fv1VPL,cplcFv1Fv1VPR,cplcFv1Fv1VZL,cplcFv1Fv1VZR,cplcgWCgWCVP,cplcgWCgWCVZ,     & 
& cplcgWpgWpVP,cplcgWpgWpVZ,cplcgXp1gXp1VP,cplcgXp1gXp1VZ,cplcgXp2gXp2VP,cplcgXp2gXp2VZ, & 
& cplcHpmcVWpVP,cplcHpmcVWpVZ,cplcHpmcVXpVP,cplcHpmcVXpVZ,cplcVWpVPVWp,cplcVWpVPVWpVZ1,  & 
& cplcVWpVPVWpVZ2,cplcVWpVPVWpVZ3,cplcVWpVWpVZ,cplcVXpVPVXp,cplcVXpVPVXpVZ1,             & 
& cplcVXpVPVXpVZ2,cplcVXpVPVXpVZ3,cplcVXpVXpVZ,cplDpmcDpmVP,cplDpmcDpmVPVZ,              & 
& cplDpmcDpmVZ,cplhhhhVPVZ,cplhhVPVZ,cplhhVPVZp,cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,       & 
& cplHpmcHpmVPVZ,cplHpmcHpmVZ,cplHpmVPVWp,cplHpmVPVXp,cplHpmVWpVZ,cplHpmVXpVZ,           & 
& kont,PiZg_mz2)

Call Pi1LoopVP(MVZ2,Mhh,Mhh2,MAh,MAh2,MDpm,MDpm2,MFd,MFd2,MFe,MFe2,MFu,               & 
& MFu2,MVZ,MVZ2,MVZp,MVZp2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,cplAhhhVP,cplDpmcDpmVP,      & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFeFeVPL,cplcFeFeVPR,cplcFuFuVPL,cplcFuFuVPR,               & 
& cplcFv1Fv1VPL,cplcFv1Fv1VPR,cplcgWpgWpVP,cplcgWCgWCVP,cplcgXp1gXp1VP,cplcgXp2gXp2VP,   & 
& cplhhVPVZ,cplhhVPVZp,cplHpmcHpmVP,cplHpmVPVWp,cplHpmVPVXp,cplcVWpVPVWp,cplcVXpVPVXp,   & 
& cplAhAhVPVP,cplDpmcDpmVPVP,cplhhhhVPVP,cplHpmcHpmVPVP,cplcVWpVPVPVWp3,cplcVWpVPVPVWp1, & 
& cplcVWpVPVPVWp2,cplcVXpVPVPVXp3,cplcVXpVPVPVXp1,cplcVXpVPVPVXp2,kont,Pigg_mz2)
...
Subroutine CalculateLowEnergyConstraints(g1input,g2input,g3input,l1input,             & 
& l12input,l13input,l12tinput,l13tinput,l2input,l23input,l23tinput,l3input,              & 
& hll1input,hdp11input,hd1input,hdtp11input,hdt1input,hup11input,hUp1input,              & 
& hdp1input,hd2input,hdtp1input,hdt2input,hup21input,hUp2input,hd3input,hdt3input,       & 
& hu11input,h12input,hU1input,hU2input,ftriinput,mu12input,mu22input,mu32input,          & 
& Vninput,v1input,v2input,Tpar,Spar,Upar,ae,amu,atau,EDMe,EDMmu,EDMtau,dRho,             & 
...
Real(dp),Intent(inout) :: g1input,g2input,g3input,ftriinput,mu12input,mu22input,mu32input,Vninput,              & 
& v1input,v2input

Complex(dp),Intent(inout) :: l1input,l12input,l13input,l12tinput,l13tinput,l2input,l23input,l23tinput,             & 
...
Complex(dp) :: cplAhAhAh(3,3,3),cplAhAhcVWpVWp(3,3),cplAhAhhh(3,3,3),cplAhAhVPVP(3,3),               & 
& cplAhAhVPVZ(3,3),cplAhAhVPVZp(3,3),cplAhAhVZVZ(3,3),cplAhAhVZVZp(3,3),cplAhcHpmcVWp(3,4),& 
& cplAhcHpmcVXp(3,4),cplAhDpmcDpm(3,2,2),cplAhhhhh(3,3,3),cplAhhhVP(3,3),cplAhhhVZ(3,3), & 
& cplAhhhVZp(3,3),cplAhHpmcHpm(3,4,4),cplAhHpmVWp(3,4),cplAhHpmVXp(3,4),cplcDpmcHpmcVXp(2,4),& 
& cplcDpmcVXpVWp(2),cplcFdFdAhL(5,5,3),cplcFdFdAhR(5,5,3),cplcFdFdcDpmL(5,5,2),          & 
& cplcFdFdcDpmR(5,5,2),cplcFdFdDpmL(5,5,2),cplcFdFdDpmR(5,5,2),cplcFdFdhhL(5,5,3),       & 
& cplcFdFdhhR(5,5,3),cplcFdFdVGL(5,5),cplcFdFdVGR(5,5),cplcFdFdVPL(5,5),cplcFdFdVPR(5,5),& 
& cplcFdFdVZL(5,5),cplcFdFdVZpL(5,5),cplcFdFdVZpR(5,5),cplcFdFdVZR(5,5),cplcFdFucVWpL(5,4),& 
& cplcFdFucVWpR(5,4),cplcFdFucVXpL(5,4),cplcFdFucVXpR(5,4),cplcFdFuHpmL(5,4,4),          & 
& cplcFdFuHpmR(5,4,4),cplcFecFv1HpmL(3,3,4),cplcFecFv1HpmR(3,3,4),cplcFeFeAhL(3,3,3),    & 
...
& cplcFeFv1cVWpL(3,3),cplcFeFv1cVWpR(3,3),cplcFeFv1HpmL(3,3,4),cplcFeFv1HpmR(3,3,4),     & 
& cplcFuFdcHpmL(4,5,4),cplcFuFdcHpmR(4,5,4),cplcFuFdVWpL(4,5),cplcFuFdVWpR(4,5),         & 
& cplcFuFdVXpL(4,5),cplcFuFdVXpR(4,5),cplcFuFuAhL(4,4,3),cplcFuFuAhR(4,4,3),             & 
& cplcFuFucDpmL(4,4,2),cplcFuFucDpmR(4,4,2),cplcFuFuDpmL(4,4,2),cplcFuFuDpmR(4,4,2),     & 
& cplcFuFuhhL(4,4,3),cplcFuFuhhR(4,4,3),cplcFuFuVGL(4,4),cplcFuFuVGR(4,4),               & 
& cplcFuFuVPL(4,4),cplcFuFuVPR(4,4),cplcFuFuVZL(4,4),cplcFuFuVZpL(4,4),cplcFuFuVZpR(4,4),& 
& cplcFuFuVZR(4,4),cplcFv1FecHpmL(3,3,4),cplcFv1FecHpmR(3,3,4),cplcFv1FeVWpL(3,3),       & 
& cplcFv1FeVWpR(3,3),cplcFv1Fv1VPL(3,3),cplcFv1Fv1VPR(3,3),cplcFv1Fv1VZL(3,3),           & 
& cplcFv1Fv1VZpL(3,3),cplcFv1Fv1VZpR(3,3),cplcFv1Fv1VZR(3,3),cplcgAgWpcVWp,              & 
& cplcgWCgAcVWp,cplcgWCgWCVP,cplcgWCgWCVZ,cplcgWCgZcVWp,cplcgWCgZpcVWp,cplcgWpgWpVP,     & 
& cplcgWpgWpVZ,cplcgXp1gXp1VP,cplcgXp1gXp1VZ,cplcgXp2gXp2VP,cplcgXp2gXp2VZ,              & 
& cplcgZgWpcVWp,cplcgZpgWpcVWp,cplcHpmcVWpVP(4),cplcHpmcVWpVZ(4),cplcHpmcVWpVZp(4),      & 
& cplcHpmcVXpVP(4),cplcHpmcVXpVZ(4),cplcHpmcVXpVZp(4),cplcVWpcVWpVWpVWp1,cplcVWpcVWpVWpVWp2,& 
& cplcVWpcVWpVWpVWp3,cplcVWpcVXpVWpVXp1,cplcVWpcVXpVWpVXp2,cplcVWpcVXpVWpVXp3,           & 
...
& cplcVWpVWpVZVZp3,cplcVXpVPVPVXp1,cplcVXpVPVPVXp2,cplcVXpVPVPVXp3,cplcVXpVPVXp,         & 
& cplcVXpVPVXpVZ1,cplcVXpVPVXpVZ2,cplcVXpVPVXpVZ3,cplcVXpVPVXpVZp1,cplcVXpVPVXpVZp2,     & 
& cplcVXpVPVXpVZp3,cplcVXpVXpVZ,cplcVXpVXpVZp,cplcVXpVXpVZVZ1,cplcVXpVXpVZVZ2,           & 
& cplcVXpVXpVZVZ3,cplcVXpVXpVZVZp1,cplcVXpVXpVZVZp2,cplcVXpVXpVZVZp3,cplDpmcDpmcVWpVWp(2,2),& 
& cplDpmcDpmVP(2,2),cplDpmcDpmVPVP(2,2),cplDpmcDpmVPVZ(2,2),cplDpmcDpmVPVZp(2,2),        & 
& cplDpmcDpmVZ(2,2),cplDpmcDpmVZp(2,2),cplDpmcDpmVZVZ(2,2),cplDpmcDpmVZVZp(2,2),         & 
& cplDpmcHpmcVWp(2,4),cplDpmcVWpVXp(2),cplDpmhhcDpm(2,3,2),cplDpmHpmcHpm(2,4,4)

Complex(dp) :: cplDpmHpmVXp(2,4),cplFeFv1cHpmL(3,3,4),cplFeFv1cHpmR(3,3,4),cplhhcHpmcVWp(3,4),        & 
& cplhhcHpmcVXp(3,4),cplhhcVWpVWp(3),cplhhcVXpVXp(3),cplhhhhcVWpVWp(3,3),cplhhhhhh(3,3,3),& 
& cplhhhhVPVP(3,3),cplhhhhVPVZ(3,3),cplhhhhVPVZp(3,3),cplhhhhVZVZ(3,3),cplhhhhVZVZp(3,3),& 
& cplhhHpmcHpm(3,4,4),cplhhHpmVWp(3,4),cplhhHpmVXp(3,4),cplhhVPVZ(3),cplhhVPVZp(3),      & 
& cplhhVZpVZp(3),cplhhVZVZ(3),cplhhVZVZp(3),cplHpmcDpmcHpm(4,2,4),cplHpmcDpmVWp(4,2),    & 
& cplHpmcHpmcVWpVWp(4,4),cplHpmcHpmcVXpVWp(4,4),cplHpmcHpmVP(4,4),cplHpmcHpmVPVP(4,4),   & 
& cplHpmcHpmVPVZ(4,4),cplHpmcHpmVPVZp(4,4),cplHpmcHpmVZ(4,4),cplHpmcHpmVZp(4,4),         & 
& cplHpmcHpmVZVZ(4,4),cplHpmcHpmVZVZp(4,4),cplHpmVPVWp(4),cplHpmVPVXp(4),cplHpmVWpVZ(4), & 
& cplHpmVWpVZp(4),cplHpmVXpVZ(4),cplHpmVXpVZp(4),cplVGVGVG
...
scale_save = Qin 
Call RunSM_and_SUSY_RGEs(160._dp,g1input,g2input,g3input,l1input,l12input,            & 
...
& h12,hU1,hU2,ftri,mu12,mu22,mu32,Vn,v1,v2,CKM_160,sinW2_160,Alpha_160,AlphaS_160,.false.)
...
MHpm(2)=MVXp
MHpm2(2)=MVXp2
Call AllCouplings(ftri,ZA,l1,l12,l13,l2,l23,l3,Vn,v1,v2,ZH,l12t,zy,l13t,              & 
& l23t,ZP,g1,g2,ZZ,g3,hdp11,hd1,hdtp11,hdt1,hdp1,hd2,hdtp1,hdt2,hd3,hdt3,Vd,             & 
...
& cplhhhhhh,cplhhHpmcHpm,cplHpmcDpmcHpm,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplAhHpmVWp,      & 
& cplAhHpmVXp,cplAhcHpmcVWp,cplAhcHpmcVXp,cplDpmHpmVXp,cplDpmcDpmVP,cplDpmcDpmVZ,        & 
& cplDpmcDpmVZp,cplDpmcHpmcVWp,cplhhHpmVWp,cplhhHpmVXp,cplhhcHpmcVWp,cplhhcHpmcVXp,      & 
& cplHpmcHpmVP,cplHpmcDpmVWp,cplHpmcHpmVZ,cplHpmcHpmVZp,cplcDpmcHpmcVXp,cplDpmcVWpVXp,   & 
& cplhhVPVZ,cplhhVPVZp,cplhhcVWpVWp,cplhhcVXpVXp,cplhhVZVZ,cplhhVZVZp,cplhhVZpVZp,       & 
& cplHpmVPVWp,cplHpmVPVXp,cplHpmVWpVZ,cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,             & 
& cplcHpmcVWpVP,cplcHpmcVXpVP,cplcDpmcVXpVWp,cplcHpmcVWpVZ,cplcHpmcVXpVZ,cplcHpmcVWpVZp, & 
& cplcHpmcVXpVZp,cplVGVGVG,cplcVWpVPVWp,cplcVXpVPVXp,cplcVWpVWpVZ,cplcVWpVWpVZp,         & 
& cplcVXpVXpVZ,cplcVXpVXpVZp,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,            & 
& cplcFuFuAhL,cplcFuFuAhR,cplcFdFdDpmL,cplcFdFdDpmR,cplcFuFuDpmL,cplcFuFuDpmR,           & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFdFdcDpmL,cplcFdFdcDpmR,cplcFuFdcHpmL,cplcFuFdcHpmR,       & 
& cplFeFv1cHpmL,cplFeFv1cHpmR,cplcFeFehhL,cplcFeFehhR,cplcFv1FecHpmL,cplcFv1FecHpmR,     & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFdFuHpmL,cplcFdFuHpmR,cplcFuFucDpmL,cplcFuFucDpmR,         & 
& cplcFeFv1HpmL,cplcFeFv1HpmR,cplcFecFv1HpmL,cplcFecFv1HpmR,cplcFdFdVGL,cplcFdFdVGR,     & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFdVXpL,cplcFuFdVXpR,           & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFdFdVZpL,cplcFdFdVZpR,cplcFeFeVPL,cplcFeFeVPR,             & 
& cplcFv1FeVWpL,cplcFv1FeVWpR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFeVZpL,cplcFeFeVZpR,         & 
& cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,               & 
& cplcFuFuVZpL,cplcFuFuVZpR,cplcFdFucVWpL,cplcFdFucVWpR,cplcFdFucVXpL,cplcFdFucVXpR,     & 
& cplcFv1Fv1VPL,cplcFv1Fv1VPR,cplcFv1Fv1VZL,cplcFv1Fv1VZR,cplcFv1Fv1VZpL,cplcFv1Fv1VZpR, & 
& cplcFeFv1cVWpL,cplcFeFv1cVWpR)
...
Call CalculateTreeS2d2L(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MDpm,MDpm2,MFd,              & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,             & 
& MVZp,MVZp2,cplAhAhAh,cplAhAhhh,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhDpmcDpm,               & 
& cplAhhhhh,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmVWp,cplAhHpmVXp,         & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,         & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZpL,              & 
& cplcFdFdVZpR,cplcFdFdVZR,cplcFdFucVWpL,cplcFdFucVWpR,cplcFdFucVXpL,cplcFdFucVXpR,      & 
& cplcFdFuHpmL,cplcFdFuHpmR,cplcFecFv1HpmL,cplcFecFv1HpmR,cplcFeFeAhL,cplcFeFeAhR,       & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZpL,              & 
& cplcFeFeVZpR,cplcFeFeVZR,cplcFeFv1cVWpL,cplcFeFv1cVWpR,cplcFeFv1HpmL,cplcFeFv1HpmR,    & 
& cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFdVXpL,cplcFuFdVXpR,       & 
& cplcFuFuAhL,cplcFuFuAhR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVPL,cplcFuFuVPR,               & 
& cplcFuFuVZL,cplcFuFuVZpL,cplcFuFuVZpR,cplcFuFuVZR,cplcFv1FecHpmL,cplcFv1FecHpmR,       & 
& cplcFv1FeVWpL,cplcFv1FeVWpR,cplcHpmcVWpVP,cplcHpmcVWpVZ,cplcHpmcVWpVZp,cplcHpmcVXpVP,  & 
& cplcHpmcVXpVZ,cplcHpmcVXpVZp,cplcVWpVPVWp,cplcVWpVWpVZ,cplcVWpVWpVZp,cplcVXpVPVXp,     & 
& cplcVXpVXpVZ,cplcVXpVXpVZp,cplDpmcDpmVP,cplDpmcDpmVZ,cplDpmcDpmVZp,cplDpmhhcDpm,       & 
& cplFeFv1cHpmL,cplFeFv1cHpmR,cplhhcHpmcVWp,cplhhcHpmcVXp,cplhhcVWpVWp,cplhhcVXpVXp,     & 
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmVWp,cplhhHpmVXp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,       & 
& cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,              & 
& cplHpmVPVXp,cplHpmVWpVZ,cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,TSOddllSLL(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeV2d2L(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MDpm,MDpm2,MFd,              & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,             & 
& MVZp,MVZp2,cplAhAhAh,cplAhAhhh,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhDpmcDpm,               & 
& cplAhhhhh,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmVWp,cplAhHpmVXp,         & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,         & 
...
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmVWp,cplhhHpmVXp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,       & 
& cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,              & 
& cplHpmVPVXp,cplHpmVWpVZ,cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,TVOddllSLL(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeS2d2nu(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MDpm,MDpm2,MFd,             & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,             & 
& MVZp,MVZp2,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,       & 
& cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,           & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZpL,cplcFdFdVZpR,cplcFdFdVZR,cplcFdFucVWpL,           & 
& cplcFdFucVWpR,cplcFdFucVXpL,cplcFdFucVXpR,cplcFdFuHpmL,cplcFdFuHpmR,cplcFecFv1HpmL,    & 
& cplcFecFv1HpmR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZpL,cplcFeFeVZpR,          & 
& cplcFeFeVZR,cplcFeFv1cVWpL,cplcFeFv1cVWpR,cplcFeFv1HpmL,cplcFeFv1HpmR,cplcFuFdcHpmL,   & 
& cplcFuFdcHpmR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFdVXpL,cplcFuFdVXpR,cplcFuFuVPL,         & 
& cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZpL,cplcFuFuVZpR,cplcFuFuVZR,cplcFv1FecHpmL,          & 
& cplcFv1FecHpmR,cplcFv1FeVWpL,cplcFv1FeVWpR,cplcFv1Fv1VPL,cplcFv1Fv1VPR,cplcFv1Fv1VZL,  & 
& cplcFv1Fv1VZpL,cplcFv1Fv1VZpR,cplcFv1Fv1VZR,cplcHpmcVWpVP,cplcHpmcVWpVZ,               & 
& cplcHpmcVWpVZp,cplcHpmcVXpVP,cplcHpmcVXpVZ,cplcHpmcVXpVZp,cplcVWpVPVWp,cplcVWpVWpVZ,   & 
& cplcVWpVWpVZp,cplcVXpVPVXp,cplcVXpVXpVZ,cplcVXpVXpVZp,cplDpmcDpmVP,cplDpmcDpmVZ,       & 
& cplDpmcDpmVZp,cplFeFv1cHpmL,cplFeFv1cHpmR,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,            & 
& cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,              & 
& cplHpmVPVXp,cplHpmVWpVZ,cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,TSOddvvVRR(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeV2d2nu(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MDpm,MDpm2,MFd,             & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,             & 
& MVZp,MVZp2,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,       & 
& cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,           & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZpL,cplcFdFdVZpR,cplcFdFdVZR,cplcFdFucVWpL,           & 
...
& cplDpmcDpmVZp,cplFeFv1cHpmL,cplFeFv1cHpmR,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,            & 
& cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,              & 
& cplHpmVPVXp,cplHpmVWpVZ,cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,TVOddvvVRR(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeS4d(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MDpm,MDpm2,MFd,MFd2,           & 
& MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhAh,      & 
& cplAhAhhh,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhDpmcDpm,cplAhhhhh,cplAhhhVP,cplAhhhVZ,      & 
& cplAhhhVZp,cplAhHpmcHpm,cplAhHpmVWp,cplAhHpmVXp,cplcDpmcHpmcVXp,cplcDpmcVXpVWp,        & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,         & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,               & 
& cplcFdFdVZL,cplcFdFdVZpL,cplcFdFdVZpR,cplcFdFdVZR,cplcFdFucVWpL,cplcFdFucVWpR,         & 
& cplcFdFucVXpL,cplcFdFucVXpR,cplcFdFuHpmL,cplcFdFuHpmR,cplcFuFdcHpmL,cplcFuFdcHpmR,     & 
& cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFdVXpL,cplcFuFdVXpR,cplcFuFuAhL,cplcFuFuAhR,           & 
& cplcFuFucDpmL,cplcFuFucDpmR,cplcFuFuDpmL,cplcFuFuDpmR,cplcFuFuhhL,cplcFuFuhhR,         & 
& cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZpL,              & 
& cplcFuFuVZpR,cplcFuFuVZR,cplcHpmcVWpVP,cplcHpmcVWpVZ,cplcHpmcVWpVZp,cplcHpmcVXpVP,     & 
& cplcHpmcVXpVZ,cplcHpmcVXpVZp,cplcVWpVPVWp,cplcVWpVWpVZ,cplcVWpVWpVZp,cplcVXpVPVXp,     & 
& cplcVXpVXpVZ,cplcVXpVXpVZp,cplDpmcDpmVP,cplDpmcDpmVZ,cplDpmcDpmVZp,cplDpmcHpmcVWp,     & 
& cplDpmcVWpVXp,cplDpmhhcDpm,cplDpmHpmcHpm,cplDpmHpmVXp,cplhhcHpmcVWp,cplhhcHpmcVXp,     & 
& cplhhcVWpVWp,cplhhcVXpVXp,cplhhhhhh,cplhhHpmcHpm,cplhhHpmVWp,cplhhHpmVXp,              & 
& cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,cplHpmcDpmcHpm,cplHpmcDpmVWp,    & 
& cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,cplHpmVPVXp,cplHpmVWpVZ,           & 
& cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,TSO4dSLL(gt1,gt2,gt3,gt4),TSO4dSRR(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeV4d(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MDpm,MDpm2,MFd,MFd2,           & 
& MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhAh,      & 
& cplAhAhhh,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhDpmcDpm,cplAhhhhh,cplAhhhVP,cplAhhhVZ,      & 
& cplAhhhVZp,cplAhHpmcHpm,cplAhHpmVWp,cplAhHpmVXp,cplcDpmcHpmcVXp,cplcDpmcVXpVWp,        & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,         & 
...
& cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,cplHpmcDpmcHpm,cplHpmcDpmVWp,    & 
& cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,cplHpmVPVXp,cplHpmVWpVZ,           & 
& cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,TVO4dSLL(gt1,gt2,gt3,gt4),TVO4dSRR(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeSdulv(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MDpm,MDpm2,MFd,              & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,             & 
& MVZp,MVZp2,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhHpmcHpm,cplAhHpmVWp,cplcDpmcHpmcVXp,       & 
& cplcDpmcVXpVWp,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,cplcFdFdcDpmR,cplcFdFdDpmL,       & 
& cplcFdFdDpmR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZpL,cplcFdFdVZpR,            & 
& cplcFdFdVZR,cplcFdFucVWpL,cplcFdFucVWpR,cplcFdFucVXpL,cplcFdFucVXpR,cplcFdFuHpmL,      & 
& cplcFdFuHpmR,cplcFecFv1HpmL,cplcFecFv1HpmR,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,        & 
& cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZpL,cplcFeFeVZpR,cplcFeFeVZR,cplcFeFv1cVWpL,          & 
& cplcFeFv1cVWpR,cplcFeFv1HpmL,cplcFeFv1HpmR,cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdVWpL,   & 
& cplcFuFdVWpR,cplcFuFdVXpL,cplcFuFdVXpR,cplcFuFuAhL,cplcFuFuAhR,cplcFuFucDpmL,          & 
& cplcFuFucDpmR,cplcFuFuDpmL,cplcFuFuDpmR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,           & 
& cplcFuFuVZpL,cplcFuFuVZpR,cplcFuFuVZR,cplcFv1FecHpmL,cplcFv1FecHpmR,cplcFv1FeVWpL,     & 
& cplcFv1FeVWpR,cplcFv1Fv1VZL,cplcFv1Fv1VZpL,cplcFv1Fv1VZpR,cplcFv1Fv1VZR,               & 
& cplcHpmcVWpVZ,cplcHpmcVWpVZp,cplcHpmcVXpVZ,cplcHpmcVXpVZp,cplcVWpVWpVZ,cplcVWpVWpVZp,  & 
& cplDpmcHpmcVWp,cplDpmHpmcHpm,cplFeFv1cHpmL,cplFeFv1cHpmR,cplhhcHpmcVWp,cplhhcHpmcVXp,  & 
& cplhhcVWpVWp,cplhhHpmcHpm,cplhhHpmVWp,cplHpmcDpmcHpm,cplHpmcDpmVWp,cplHpmcHpmVZ,       & 
& cplHpmcHpmVZp,cplHpmVWpVZ,cplHpmVWpVZp,TSOdulvSLL(gt1,gt2,gt3,gt4),TSOdulvSRR(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeVdulv(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MDpm,MDpm2,MFd,              & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,             & 
& MVZp,MVZp2,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhHpmcHpm,cplAhHpmVWp,cplcDpmcHpmcVXp,       & 
& cplcDpmcVXpVWp,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,cplcFdFdcDpmR,cplcFdFdDpmL,       & 
& cplcFdFdDpmR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZpL,cplcFdFdVZpR,            & 
...
& cplDpmcHpmcVWp,cplDpmHpmcHpm,cplFeFv1cHpmL,cplFeFv1cHpmR,cplhhcHpmcVWp,cplhhcHpmcVXp,  & 
& cplhhcVWpVWp,cplhhHpmcHpm,cplhhHpmVWp,cplHpmcDpmcHpm,cplHpmcDpmVWp,cplHpmcHpmVZ,       & 
& cplHpmcHpmVZp,cplHpmVWpVZ,cplHpmVWpVZp,TVOdulvSLL(gt1,gt2,gt3,gt4),TVOdulvSRR(gt1,gt2,gt3,gt4)& 
...
Call CalculateBox2d2L(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MDpm,MDpm2,MFd,MFd2,           & 
& MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,MVZp,             & 
& MVZp2,cplAhAhAh,cplAhAhhh,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhDpmcDpm,cplAhhhhh,          & 
& cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmVWp,cplAhHpmVXp,cplcFdFdAhL,       & 
& cplcFdFdAhR,cplcFdFdcDpmL,cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,cplcFdFdhhL,         & 
...
& cplcFeFeVZR,cplcFeFv1cVWpL,cplcFeFv1cVWpR,cplcFeFv1HpmL,cplcFeFv1HpmR,cplcFuFdcHpmL,   & 
& cplcFuFdcHpmR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFdVXpL,cplcFuFdVXpR,cplcFuFuAhL,         & 
& cplcFuFuAhR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,               & 
& cplcFuFuVZpL,cplcFuFuVZpR,cplcFuFuVZR,cplcFv1FecHpmL,cplcFv1FecHpmR,cplcFv1FeVWpL,     & 
& cplcFv1FeVWpR,cplcHpmcVWpVP,cplcHpmcVWpVZ,cplcHpmcVWpVZp,cplcHpmcVXpVP,cplcHpmcVXpVZ,  & 
& cplcHpmcVXpVZp,cplcVWpVPVWp,cplcVWpVWpVZ,cplcVWpVWpVZp,cplcVXpVPVXp,cplcVXpVXpVZ,      & 
& cplcVXpVXpVZp,cplDpmcDpmVP,cplDpmcDpmVZ,cplDpmcDpmVZp,cplDpmhhcDpm,cplFeFv1cHpmL,      & 
& cplFeFv1cHpmR,cplhhcHpmcVWp,cplhhcHpmcVXp,cplhhcVWpVWp,cplhhcVXpVXp,cplhhhhhh,         & 
& cplhhHpmcHpm,cplhhHpmVWp,cplhhHpmVXp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,       & 
& cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,cplHpmVPVXp,            & 
& cplHpmVWpVZ,cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,BOddllSLL(gt1,gt2,gt3,gt4)           & 
...
If ((Abs(TSOddllSLL(gt1,gt2,gt3,gt4)).lt.epsTree).and. & 
 ...
 & (Abs(TVOddllTRL(gt1,gt2,gt3,gt4)).lt.epsTree).and. & 
 & (Abs(TVOddllTRR(gt1,gt2,gt3,gt4)).lt.epsTree)) Then 
Call CalculatePengS2d2L(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MDpm,MDpm2,MFd,              & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,             & 
& MVZp,MVZp2,cplAhAhAh,cplAhAhhh,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhDpmcDpm,               & 
& cplAhhhhh,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmVWp,cplAhHpmVXp,         & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,         & 
...
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmVWp,cplhhHpmVXp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,       & 
& cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,              & 
& cplHpmVPVXp,cplHpmVWpVZ,cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,PSOddllSLL(gt1,gt2,gt3,gt4)& 
...
If ((Abs(TSOddllSLL(gt1,gt2,gt3,gt4)).lt.epsTree).and. & 
 ...
 & (Abs(TVOddllTRL(gt1,gt2,gt3,gt4)).lt.epsTree).and. & 
 & (Abs(TVOddllTRR(gt1,gt2,gt3,gt4)).lt.epsTree)) Then 
Call CalculatePengV2d2L(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MDpm,MDpm2,MFd,              & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,             & 
& MVZp,MVZp2,cplAhAhAh,cplAhAhhh,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhDpmcDpm,               & 
& cplAhhhhh,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmVWp,cplAhHpmVXp,         & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,         & 
...
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmVWp,cplhhHpmVXp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,       & 
& cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,              & 
& cplHpmVPVXp,cplHpmVWpVZ,cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,PVOddllSLL(gt1,gt2,gt3,gt4)& 
...
Call CalculateBox2d2nu(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MDpm,MDpm2,MFd,               & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,             & 
& MVZp,MVZp2,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,       & 
& cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,           & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZpL,cplcFdFdVZpR,cplcFdFdVZR,cplcFdFucVWpL,           & 
...
& cplDpmcDpmVZp,cplFeFv1cHpmL,cplFeFv1cHpmR,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,            & 
& cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,              & 
& cplHpmVPVXp,cplHpmVWpVZ,cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,BOddvvVRR(gt1,gt2,gt3,gt4)& 
...
If ((Abs(TSOddvvVRR(gt1,gt2,gt3,gt4)).lt.epsTree).and. & 
 ...
 & (Abs(TVOddvvVRL(gt1,gt2,gt3,gt4)).lt.epsTree).and. & 
 & (Abs(TVOddvvVLR(gt1,gt2,gt3,gt4)).lt.epsTree)) Then 
Call CalculatePengS2d2nu(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MDpm,MDpm2,MFd,             & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,             & 
& MVZp,MVZp2,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,       & 
& cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,           & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZpL,cplcFdFdVZpR,cplcFdFdVZR,cplcFdFucVWpL,           & 
...
& cplDpmcDpmVZp,cplFeFv1cHpmL,cplFeFv1cHpmR,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,            & 
& cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,              & 
& cplHpmVPVXp,cplHpmVWpVZ,cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,PSOddvvVRR(gt1,gt2,gt3,gt4)& 
...
If ((Abs(TSOddvvVRR(gt1,gt2,gt3,gt4)).lt.epsTree).and. & 
 ...
 & (Abs(TVOddvvVRL(gt1,gt2,gt3,gt4)).lt.epsTree).and. & 
 & (Abs(TVOddvvVLR(gt1,gt2,gt3,gt4)).lt.epsTree)) Then 
Call CalculatePengV2d2nu(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MDpm,MDpm2,MFd,             & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,             & 
& MVZp,MVZp2,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,       & 
& cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,           & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZpL,cplcFdFdVZpR,cplcFdFdVZR,cplcFdFucVWpL,           & 
...
& cplDpmcDpmVZp,cplFeFv1cHpmL,cplFeFv1cHpmR,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,            & 
& cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,              & 
& cplHpmVPVXp,cplHpmVWpVZ,cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,PVOddvvVRR(gt1,gt2,gt3,gt4)& 
...
Call CalculateBox4d(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MDpm,MDpm2,MFd,MFd2,             & 
& MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhAh,      & 
& cplAhAhhh,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhDpmcDpm,cplAhhhhh,cplAhhhVP,cplAhhhVZ,      & 
& cplAhhhVZp,cplAhHpmcHpm,cplAhHpmVWp,cplAhHpmVXp,cplcDpmcHpmcVXp,cplcDpmcVXpVWp,        & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,         & 
...
& cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,cplHpmcDpmcHpm,cplHpmcDpmVWp,    & 
& cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,cplHpmVPVXp,cplHpmVWpVZ,           & 
& cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,BO4dSLL(gt1,gt2,gt3,gt4),BO4dSRR(gt1,gt2,gt3,gt4)& 
...
gt2 = IndexArray3(i1,2) 
 Do i2=1,3 
  gt3=i2 
Call CalculateA2q(gt1,gt2,gt3,.False.,MAh,MAh2,MDpm,MDpm2,MFd,MFd2,MFu,               & 
& MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhAh,          & 
& cplAhAhhh,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhDpmcDpm,cplAhhhhh,cplAhhhVZ,cplAhhhVZp,     & 
& cplAhHpmcHpm,cplAhHpmVWp,cplAhHpmVXp,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,            & 
& cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,           & 
& cplcFdFdVZpL,cplcFdFdVZpR,cplcFdFdVZR,cplcFdFucVWpL,cplcFdFucVWpR,cplcFdFucVXpL,       & 
& cplcFdFucVXpR,cplcFdFuHpmL,cplcFdFuHpmR,cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdVWpL,      & 
& cplcFuFdVWpR,cplcFuFdVXpL,cplcFuFdVXpR,cplcFuFuAhL,cplcFuFuAhR,OAh2qSL(gt1,gt2,gt3)    & 
& ,OAh2qSR(gt1,gt2,gt3))
...
gt2 = IndexArray2(i1,2) 
  gt3= 1 
Call CalculateGamma2Q(gt1,gt2,gt3,.False.,MAh,MAh2,MDpm,MDpm2,MFd,MFd2,               & 
& MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,MVZp,MVZp2,cplAhhhVP,      & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,         & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZpL,              & 
& cplcFdFdVZpR,cplcFdFdVZR,cplcFdFucVWpL,cplcFdFucVWpR,cplcFdFucVXpL,cplcFdFucVXpR,      & 
& cplcFdFuHpmL,cplcFdFuHpmR,cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdVWpL,cplcFuFdVWpR,       & 
& cplcFuFdVXpL,cplcFuFdVXpR,cplcFuFuVPL,cplcFuFuVPR,cplcHpmcVWpVP,cplcHpmcVXpVP,         & 
& cplcVWpVPVWp,cplcVXpVPVXp,cplDpmcDpmVP,cplhhVPVZ,cplhhVPVZp,cplHpmcHpmVP,              & 
& cplHpmVPVWp,cplHpmVPVXp,OA2qSL(gt1,gt2),OA2qSR(gt1,gt2),OA2qVL(gt1,gt2),               & 
& OA2qVR(gt1,gt2))
...
gt2 = IndexArray2(i1,2) 
  gt3= 1 
Call CalculateGluon2Q(gt1,gt2,gt3,.False.,MAh,MAh2,MDpm,MDpm2,MFd,MFd2,               & 
& MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,MVZp,MVZp2,cplcFdFdAhL,    & 
& cplcFdFdAhR,cplcFdFdcDpmL,cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,cplcFdFdhhL,         & 
& cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVZL,cplcFdFdVZpL,cplcFdFdVZpR,             & 
& cplcFdFdVZR,cplcFdFucVWpL,cplcFdFucVWpR,cplcFdFucVXpL,cplcFdFucVXpR,cplcFdFuHpmL,      & 
& cplcFdFuHpmR,cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFdVXpL,       & 
& cplcFuFdVXpR,cplcFuFuVGL,cplcFuFuVGR,OG2qSL(gt1,gt2),OG2qSR(gt1,gt2))
...
gt2 = IndexArray3(i1,2) 
 Do i2=1,3 
  gt3=i2 
Call CalculateH2q(gt1,gt2,gt3,.False.,MAh,MAh2,MDpm,MDpm2,MFd,MFd2,MFu,               & 
& MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhhh,          & 
& cplAhhhhh,cplAhhhVZ,cplAhhhVZp,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,cplcFdFdcDpmR,    & 
& cplcFdFdDpmL,cplcFdFdDpmR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZpL,            & 
& cplcFdFdVZpR,cplcFdFdVZR,cplcFdFucVWpL,cplcFdFucVWpR,cplcFdFucVXpL,cplcFdFucVXpR,      & 
& cplcFdFuHpmL,cplcFdFuHpmR,cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdVWpL,cplcFuFdVWpR,       & 
& cplcFuFdVXpL,cplcFuFdVXpR,cplcFuFuhhL,cplcFuFuhhR,cplDpmhhcDpm,cplhhcHpmcVWp,          & 
& cplhhcHpmcVXp,cplhhcVWpVWp,cplhhcVXpVXp,cplhhhhhh,cplhhHpmcHpm,cplhhHpmVWp,            & 
& cplhhHpmVXp,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,OH2qSL(gt1,gt2,gt3),OH2qSR(gt1,gt2,gt3))
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeS2d2L(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MDpm,MDpm2,MFd,               & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,             & 
& MVZp,MVZp2,cplAhAhAh,cplAhAhhh,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhDpmcDpm,               & 
& cplAhhhhh,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmVWp,cplAhHpmVXp,         & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,         & 
...
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmVWp,cplhhHpmVXp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,       & 
& cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,              & 
& cplHpmVPVXp,cplHpmVWpVZ,cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,TSOddllSLLSM(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeV2d2L(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MDpm,MDpm2,MFd,               & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,             & 
& MVZp,MVZp2,cplAhAhAh,cplAhAhhh,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhDpmcDpm,               & 
& cplAhhhhh,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmVWp,cplAhHpmVXp,         & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,         & 
...
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmVWp,cplhhHpmVXp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,       & 
& cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,              & 
& cplHpmVPVXp,cplHpmVWpVZ,cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,TVOddllSLLSM(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeS2d2nu(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MDpm,MDpm2,MFd,              & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,             & 
& MVZp,MVZp2,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,       & 
& cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,           & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZpL,cplcFdFdVZpR,cplcFdFdVZR,cplcFdFucVWpL,           & 
...
& cplDpmcDpmVZp,cplFeFv1cHpmL,cplFeFv1cHpmR,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,            & 
& cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,              & 
& cplHpmVPVXp,cplHpmVWpVZ,cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,TSOddvvVRRSM(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeV2d2nu(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MDpm,MDpm2,MFd,              & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,             & 
& MVZp,MVZp2,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,       & 
& cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,           & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZpL,cplcFdFdVZpR,cplcFdFdVZR,cplcFdFucVWpL,           & 
...
& cplDpmcDpmVZp,cplFeFv1cHpmL,cplFeFv1cHpmR,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,            & 
& cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,              & 
& cplHpmVPVXp,cplHpmVWpVZ,cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,TVOddvvVRRSM(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeS4d(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MDpm,MDpm2,MFd,MFd2,            & 
& MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhAh,      & 
& cplAhAhhh,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhDpmcDpm,cplAhhhhh,cplAhhhVP,cplAhhhVZ,      & 
& cplAhhhVZp,cplAhHpmcHpm,cplAhHpmVWp,cplAhHpmVXp,cplcDpmcHpmcVXp,cplcDpmcVXpVWp,        & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,         & 
...
& cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,cplHpmcDpmcHpm,cplHpmcDpmVWp,    & 
& cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,cplHpmVPVXp,cplHpmVWpVZ,           & 
& cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,TSO4dSLLSM(gt1,gt2,gt3,gt4),TSO4dSRRSM(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeV4d(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MDpm,MDpm2,MFd,MFd2,            & 
& MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhAh,      & 
& cplAhAhhh,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhDpmcDpm,cplAhhhhh,cplAhhhVP,cplAhhhVZ,      & 
& cplAhhhVZp,cplAhHpmcHpm,cplAhHpmVWp,cplAhHpmVXp,cplcDpmcHpmcVXp,cplcDpmcVXpVWp,        & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,         & 
...
& cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,cplHpmcDpmcHpm,cplHpmcDpmVWp,    & 
& cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,cplHpmVPVXp,cplHpmVWpVZ,           & 
& cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,TVO4dSLLSM(gt1,gt2,gt3,gt4),TVO4dSRRSM(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeSdulv(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MDpm,MDpm2,MFd,               & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,             & 
& MVZp,MVZp2,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhHpmcHpm,cplAhHpmVWp,cplcDpmcHpmcVXp,       & 
& cplcDpmcVXpVWp,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,cplcFdFdcDpmR,cplcFdFdDpmL,       & 
& cplcFdFdDpmR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZpL,cplcFdFdVZpR,            & 
...
& cplDpmcHpmcVWp,cplDpmHpmcHpm,cplFeFv1cHpmL,cplFeFv1cHpmR,cplhhcHpmcVWp,cplhhcHpmcVXp,  & 
& cplhhcVWpVWp,cplhhHpmcHpm,cplhhHpmVWp,cplHpmcDpmcHpm,cplHpmcDpmVWp,cplHpmcHpmVZ,       & 
& cplHpmcHpmVZp,cplHpmVWpVZ,cplHpmVWpVZp,TSOdulvSLLSM(gt1,gt2,gt3,gt4),TSOdulvSRRSM(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeVdulv(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MDpm,MDpm2,MFd,               & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,             & 
& MVZp,MVZp2,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhHpmcHpm,cplAhHpmVWp,cplcDpmcHpmcVXp,       & 
& cplcDpmcVXpVWp,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,cplcFdFdcDpmR,cplcFdFdDpmL,       & 
& cplcFdFdDpmR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZpL,cplcFdFdVZpR,            & 
...
& cplDpmcHpmcVWp,cplDpmHpmcHpm,cplFeFv1cHpmL,cplFeFv1cHpmR,cplhhcHpmcVWp,cplhhcHpmcVXp,  & 
& cplhhcVWpVWp,cplhhHpmcHpm,cplhhHpmVWp,cplHpmcDpmcHpm,cplHpmcDpmVWp,cplHpmcHpmVZ,       & 
& cplHpmcHpmVZp,cplHpmVWpVZ,cplHpmVWpVZp,TVOdulvSLLSM(gt1,gt2,gt3,gt4),TVOdulvSRRSM(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateBox2d2L(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MDpm,MDpm2,MFd,MFd2,            & 
& MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,MVZp,             & 
& MVZp2,cplAhAhAh,cplAhAhhh,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhDpmcDpm,cplAhhhhh,          & 
& cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmVWp,cplAhHpmVXp,cplcFdFdAhL,       & 
& cplcFdFdAhR,cplcFdFdcDpmL,cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,cplcFdFdhhL,         & 
...
& cplhhHpmcHpm,cplhhHpmVWp,cplhhHpmVXp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,       & 
& cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,cplHpmVPVXp,            & 
& cplHpmVWpVZ,cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,BOddllSLLSM(gt1,gt2,gt3,gt4)         & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengS2d2L(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MDpm,MDpm2,MFd,               & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,             & 
& MVZp,MVZp2,cplAhAhAh,cplAhAhhh,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhDpmcDpm,               & 
& cplAhhhhh,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmVWp,cplAhHpmVXp,         & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,         & 
...
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmVWp,cplhhHpmVXp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,       & 
& cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,              & 
& cplHpmVPVXp,cplHpmVWpVZ,cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,PSOddllSLLSM(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengV2d2L(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MDpm,MDpm2,MFd,               & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,             & 
& MVZp,MVZp2,cplAhAhAh,cplAhAhhh,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhDpmcDpm,               & 
& cplAhhhhh,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmVWp,cplAhHpmVXp,         & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,         & 
...
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmVWp,cplhhHpmVXp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,       & 
& cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,              & 
& cplHpmVPVXp,cplHpmVWpVZ,cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,PVOddllSLLSM(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateBox2d2nu(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MDpm,MDpm2,MFd,MFd2,           & 
& MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,MVZp,             & 
& MVZp2,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,            & 
& cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,           & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZpL,cplcFdFdVZpR,cplcFdFdVZR,cplcFdFucVWpL,           & 
& cplcFdFucVWpR,cplcFdFucVXpL,cplcFdFucVXpR,cplcFdFuHpmL,cplcFdFuHpmR,cplcFecFv1HpmL,    & 
& cplcFecFv1HpmR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZpL,cplcFeFeVZpR,          & 
...
& cplDpmcDpmVZp,cplFeFv1cHpmL,cplFeFv1cHpmR,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,            & 
& cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,              & 
& cplHpmVPVXp,cplHpmVWpVZ,cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,BOddvvVRRSM(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengS2d2nu(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MDpm,MDpm2,MFd,              & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,             & 
& MVZp,MVZp2,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,       & 
& cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,           & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZpL,cplcFdFdVZpR,cplcFdFdVZR,cplcFdFucVWpL,           & 
...
& cplDpmcDpmVZp,cplFeFv1cHpmL,cplFeFv1cHpmR,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,            & 
& cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,              & 
& cplHpmVPVXp,cplHpmVWpVZ,cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,PSOddvvVRRSM(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengV2d2nu(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MDpm,MDpm2,MFd,              & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,             & 
& MVZp,MVZp2,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,       & 
& cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,           & 
& cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZpL,cplcFdFdVZpR,cplcFdFdVZR,cplcFdFucVWpL,           & 
...
& cplDpmcDpmVZp,cplFeFv1cHpmL,cplFeFv1cHpmR,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,            & 
& cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,              & 
& cplHpmVPVXp,cplHpmVWpVZ,cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,PVOddvvVRRSM(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateBox4d(gt1,gt2,gt3,gt4,.true.,MAh,MAh2,MDpm,MDpm2,MFd,MFd2,              & 
& MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhAh,      & 
& cplAhAhhh,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhDpmcDpm,cplAhhhhh,cplAhhhVP,cplAhhhVZ,      & 
& cplAhhhVZp,cplAhHpmcHpm,cplAhHpmVWp,cplAhHpmVXp,cplcDpmcHpmcVXp,cplcDpmcVXpVWp,        & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,         & 
...
& cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,cplHpmcDpmcHpm,cplHpmcDpmVWp,    & 
& cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,cplHpmVPVXp,cplHpmVWpVZ,           & 
& cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,BO4dSLLSM(gt1,gt2,gt3,gt4),BO4dSRRSM(gt1,gt2,gt3,gt4)& 
...
gt2 = IndexArray3(i1,2) 
 Do i2=1,3 
  gt3=i2 
Call CalculateA2q(gt1,gt2,gt3,.true.,MAh,MAh2,MDpm,MDpm2,MFd,MFd2,MFu,MFu2,           & 
& Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhAh,               & 
& cplAhAhhh,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhDpmcDpm,cplAhhhhh,cplAhhhVZ,cplAhhhVZp,     & 
& cplAhHpmcHpm,cplAhHpmVWp,cplAhHpmVXp,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,            & 
& cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,           & 
& cplcFdFdVZpL,cplcFdFdVZpR,cplcFdFdVZR,cplcFdFucVWpL,cplcFdFucVWpR,cplcFdFucVXpL,       & 
& cplcFdFucVXpR,cplcFdFuHpmL,cplcFdFuHpmR,cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdVWpL,      & 
& cplcFuFdVWpR,cplcFuFdVXpL,cplcFuFdVXpR,cplcFuFuAhL,cplcFuFuAhR,OAh2qSLSM(gt1,gt2,gt3)  & 
...
gt2 = IndexArray2(i1,2) 
  gt3= 1 
Call CalculateGamma2Q(gt1,gt2,gt3,.true.,MAh,MAh2,MDpm,MDpm2,MFd,MFd2,MFu,            & 
& MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,MVZp,MVZp2,cplAhhhVP,          & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,         & 
& cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZpL,              & 
& cplcFdFdVZpR,cplcFdFdVZR,cplcFdFucVWpL,cplcFdFucVWpR,cplcFdFucVXpL,cplcFdFucVXpR,      & 
& cplcFdFuHpmL,cplcFdFuHpmR,cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdVWpL,cplcFuFdVWpR,       & 
& cplcFuFdVXpL,cplcFuFdVXpR,cplcFuFuVPL,cplcFuFuVPR,cplcHpmcVWpVP,cplcHpmcVXpVP,         & 
& cplcVWpVPVWp,cplcVXpVPVXp,cplDpmcDpmVP,cplhhVPVZ,cplhhVPVZp,cplHpmcHpmVP,              & 
& cplHpmVPVWp,cplHpmVPVXp,OA2qSLSM(gt1,gt2),OA2qSRSM(gt1,gt2),OA2qVLSM(gt1,gt2)          & 
& ,OA2qVRSM(gt1,gt2))
...
gt2 = IndexArray2(i1,2) 
  gt3= 1 
Call CalculateGluon2Q(gt1,gt2,gt3,.true.,MAh,MAh2,MDpm,MDpm2,MFd,MFd2,MFu,            & 
& MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,MVZp,MVZp2,cplcFdFdAhL,        & 
& cplcFdFdAhR,cplcFdFdcDpmL,cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,cplcFdFdhhL,         & 
& cplcFdFdhhR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVZL,cplcFdFdVZpL,cplcFdFdVZpR,             & 
& cplcFdFdVZR,cplcFdFucVWpL,cplcFdFucVWpR,cplcFdFucVXpL,cplcFdFucVXpR,cplcFdFuHpmL,      & 
& cplcFdFuHpmR,cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFdVXpL,       & 
& cplcFuFdVXpR,cplcFuFuVGL,cplcFuFuVGR,OG2qSLSM(gt1,gt2),OG2qSRSM(gt1,gt2))
...
gt2 = IndexArray3(i1,2) 
 Do i2=1,3 
  gt3=i2 
Call CalculateH2q(gt1,gt2,gt3,.true.,MAh,MAh2,MDpm,MDpm2,MFd,MFd2,MFu,MFu2,           & 
...
& cplcFuFdVXpL,cplcFuFdVXpR,cplcFuFuhhL,cplcFuFuhhR,cplDpmhhcDpm,cplhhcHpmcVWp,          & 
& cplhhcHpmcVXp,cplhhcVWpVWp,cplhhcVXpVXp,cplhhhhhh,cplhhHpmcHpm,cplhhHpmVWp,            & 
& cplhhHpmVXp,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,OH2qSLSM(gt1,gt2,gt3),OH2qSRSM(gt1,gt2,gt3))
...
If (MatchingOrder.gt.-1) Then 
Call RunSM_and_SUSY_RGEs(mz,g1input,g2input,g3input,l1input,l12input,l13input,        & 
...
& hU2input,ftriinput,mu12input,mu22input,mu32input,Vninput,v1input,v2input,              & 
& g1,g2,g3,l1,l12,l13,l12t,l13t,l2,l23,l23t,l3,hll1,hdp11,hd1,hdtp11,hdt1,               & 
& hup11,hUp1,hdp1,hd2,hdtp1,hdt2,hup21,hUp2,hd3,hdt3,hu11,h12,hU1,hU2,ftri,              & 
& mu12,mu22,mu32,Vn,v1,v2,CKM_MZ,sinW2_MZ,Alpha_MZ,AlphaS_MZ,.true.)
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeS2L2d(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MDpm,MDpm2,MFd,              & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,             & 
& MVZp,MVZp2,cplAhAhAh,cplAhAhhh,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhDpmcDpm,               & 
& cplAhhhhh,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmVWp,cplAhHpmVXp,         & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,         & 
...
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmVWp,cplhhHpmVXp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,       & 
& cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,              & 
& cplHpmVPVXp,cplHpmVWpVZ,cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,TSOllddSLL(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeV2L2d(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MDpm,MDpm2,MFd,              & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,             & 
& MVZp,MVZp2,cplAhAhAh,cplAhAhhh,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhDpmcDpm,               & 
& cplAhhhhh,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmVWp,cplAhHpmVXp,         & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,         & 
...
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmVWp,cplhhHpmVXp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,       & 
& cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,              & 
& cplHpmVPVXp,cplHpmVWpVZ,cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,TVOllddSLL(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeS2L2u(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MDpm,MDpm2,MFd,              & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,             & 
& MVZp,MVZp2,cplAhAhAh,cplAhAhhh,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhDpmcDpm,               & 
& cplAhhhhh,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmVWp,cplAhHpmVXp,         & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,               & 
& cplcFdFdVZL,cplcFdFdVZpL,cplcFdFdVZpR,cplcFdFdVZR,cplcFdFucVWpL,cplcFdFucVWpR,         & 
& cplcFdFucVXpL,cplcFdFucVXpR,cplcFdFuHpmL,cplcFdFuHpmR,cplcFecFv1HpmL,cplcFecFv1HpmR,   & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,               & 
& cplcFeFeVZL,cplcFeFeVZpL,cplcFeFeVZpR,cplcFeFeVZR,cplcFeFv1cVWpL,cplcFeFv1cVWpR,       & 
& cplcFeFv1HpmL,cplcFeFv1HpmR,cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdVWpL,cplcFuFdVWpR,     & 
& cplcFuFdVXpL,cplcFuFdVXpR,cplcFuFuAhL,cplcFuFuAhR,cplcFuFucDpmL,cplcFuFucDpmR,         & 
& cplcFuFuDpmL,cplcFuFuDpmR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVPL,cplcFuFuVPR,             & 
& cplcFuFuVZL,cplcFuFuVZpL,cplcFuFuVZpR,cplcFuFuVZR,cplcFv1FecHpmL,cplcFv1FecHpmR,       & 
& cplcFv1FeVWpL,cplcFv1FeVWpR,cplcHpmcVWpVP,cplcHpmcVWpVZ,cplcHpmcVWpVZp,cplcHpmcVXpVP,  & 
& cplcHpmcVXpVZ,cplcHpmcVXpVZp,cplcVWpVPVWp,cplcVWpVWpVZ,cplcVWpVWpVZp,cplcVXpVPVXp,     & 
& cplcVXpVXpVZ,cplcVXpVXpVZp,cplDpmcDpmVP,cplDpmcDpmVZ,cplDpmcDpmVZp,cplDpmhhcDpm,       & 
...
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmVWp,cplhhHpmVXp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,       & 
& cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,              & 
& cplHpmVPVXp,cplHpmVWpVZ,cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,TSOlluuSLL(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateTreeV2L2u(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MDpm,MDpm2,MFd,              & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,             & 
& MVZp,MVZp2,cplAhAhAh,cplAhAhhh,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhDpmcDpm,               & 
& cplAhhhhh,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmVWp,cplAhHpmVXp,         & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,               & 
...
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmVWp,cplhhHpmVXp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,       & 
& cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,              & 
& cplHpmVPVXp,cplHpmVWpVZ,cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,TVOlluuSLL(gt1,gt2,gt3,gt4)& 
...
& MHpm,MHpm2,MVWp,MVWp2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhAh,cplAhAhhh,cplAhhhhh,               & 
& cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplcFecFv1HpmL,cplcFecFv1HpmR,cplcFeFeAhL,              & 
& cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,               & 
& cplcFeFeVZpL,cplcFeFeVZpR,cplcFeFeVZR,cplcFeFv1cVWpL,cplcFeFv1cVWpR,cplcFeFv1HpmL,     & 
& cplcFeFv1HpmR,cplcFv1FecHpmL,cplcFv1FecHpmR,cplcFv1FeVWpL,cplcFv1FeVWpR,               & 
& cplFeFv1cHpmL,cplFeFv1cHpmR,cplhhhhhh,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,      & 
& cplhhVZVZp,TSO4lSLL(gt1,gt2,gt3,gt4),TSO4lSRR(gt1,gt2,gt3,gt4),TSO4lSRL(gt1,gt2,gt3,gt4)& 
...
& cplcFeFv1HpmR,cplcFv1FecHpmL,cplcFv1FecHpmR,cplcFv1FeVWpL,cplcFv1FeVWpR,               & 
& cplFeFv1cHpmL,cplFeFv1cHpmR,cplhhhhhh,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,      & 
& cplhhVZVZp,TVO4lSLL(gt1,gt2,gt3,gt4),TVO4lSRR(gt1,gt2,gt3,gt4),TVO4lSRL(gt1,gt2,gt3,gt4)& 
...
& Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhAh,cplAhAhhh,cplAhhhhh,          & 
& cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplcFecFv1HpmL,cplcFecFv1HpmR,cplcFeFeAhL,              & 
& cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,               & 
& cplcFeFeVZpL,cplcFeFeVZpR,cplcFeFeVZR,cplcFeFv1cVWpL,cplcFeFv1cVWpR,cplcFeFv1HpmL,     & 
& cplcFeFv1HpmR,cplcFv1FecHpmL,cplcFv1FecHpmR,cplcFv1FeVWpL,cplcFv1FeVWpR,               & 
& cplFeFv1cHpmL,cplFeFv1cHpmR,cplhhhhhh,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,      & 
& cplhhVZVZp,TSO4lSLLcross(gt1,gt2,gt3,gt4),TSO4lSRRcross(gt1,gt2,gt3,gt4)               & 
...
& cplcFeFv1HpmR,cplcFv1FecHpmL,cplcFv1FecHpmR,cplcFv1FeVWpL,cplcFv1FeVWpR,               & 
& cplFeFv1cHpmL,cplFeFv1cHpmR,cplhhhhhh,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,      & 
& cplhhVZVZp,TVO4lSLLcross(gt1,gt2,gt3,gt4),TVO4lSRRcross(gt1,gt2,gt3,gt4)               & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateBox2L2d(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MDpm,MDpm2,MFd,MFd2,           & 
& MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,MVZp,             & 
& MVZp2,cplAhAhAh,cplAhAhhh,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhDpmcDpm,cplAhhhhh,          & 
& cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmVWp,cplAhHpmVXp,cplcFdFdAhL,       & 
& cplcFdFdAhR,cplcFdFdcDpmL,cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,cplcFdFdhhL,         & 
...
& cplhhHpmcHpm,cplhhHpmVWp,cplhhHpmVXp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,       & 
& cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,cplHpmVPVXp,            & 
& cplHpmVWpVZ,cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,BOllddSLL(gt1,gt2,gt3,gt4)           & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengS2L2d(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MDpm,MDpm2,MFd,              & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,             & 
& MVZp,MVZp2,cplAhAhAh,cplAhAhhh,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhDpmcDpm,               & 
& cplAhhhhh,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmVWp,cplAhHpmVXp,         & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,         & 
...
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmVWp,cplhhHpmVXp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,       & 
& cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,              & 
& cplHpmVPVXp,cplHpmVWpVZ,cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,PSOllddSLL(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengV2L2d(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MDpm,MDpm2,MFd,              & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,             & 
& MVZp,MVZp2,cplAhAhAh,cplAhAhhh,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhDpmcDpm,               & 
& cplAhhhhh,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmVWp,cplAhHpmVXp,         & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdcDpmL,cplcFdFdcDpmR,cplcFdFdDpmL,cplcFdFdDpmR,         & 
...
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmVWp,cplhhHpmVXp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,       & 
& cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,              & 
& cplHpmVPVXp,cplHpmVWpVZ,cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,PVOllddSLL(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculateBox2L2u(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MDpm,MDpm2,MFd,MFd2,           & 
& MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,MVZp,             & 
& MVZp2,cplAhAhAh,cplAhAhhh,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhDpmcDpm,cplAhhhhh,          & 
& cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmVWp,cplAhHpmVXp,cplcFdFdAhL,       & 
& cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,               & 
& cplcFdFdVZpL,cplcFdFdVZpR,cplcFdFdVZR,cplcFdFucVWpL,cplcFdFucVWpR,cplcFdFucVXpL,       & 
& cplcFdFucVXpR,cplcFdFuHpmL,cplcFdFuHpmR,cplcFecFv1HpmL,cplcFecFv1HpmR,cplcFeFeAhL,     & 
& cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,               & 
& cplcFeFeVZpL,cplcFeFeVZpR,cplcFeFeVZR,cplcFeFv1cVWpL,cplcFeFv1cVWpR,cplcFeFv1HpmL,     & 
& cplcFeFv1HpmR,cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFdVXpL,      & 
& cplcFuFdVXpR,cplcFuFuAhL,cplcFuFuAhR,cplcFuFucDpmL,cplcFuFucDpmR,cplcFuFuDpmL,         & 
& cplcFuFuDpmR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,              & 
& cplcFuFuVZpL,cplcFuFuVZpR,cplcFuFuVZR,cplcFv1FecHpmL,cplcFv1FecHpmR,cplcFv1FeVWpL,     & 
& cplcFv1FeVWpR,cplcHpmcVWpVP,cplcHpmcVWpVZ,cplcHpmcVWpVZp,cplcHpmcVXpVP,cplcHpmcVXpVZ,  & 
& cplcHpmcVXpVZp,cplcVWpVPVWp,cplcVWpVWpVZ,cplcVWpVWpVZp,cplcVXpVPVXp,cplcVXpVXpVZ,      & 
& cplcVXpVXpVZp,cplDpmcDpmVP,cplDpmcDpmVZ,cplDpmcDpmVZp,cplDpmhhcDpm,cplFeFv1cHpmL,      & 
...
& cplhhHpmcHpm,cplhhHpmVWp,cplhhHpmVXp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,       & 
& cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,cplHpmVPVXp,            & 
& cplHpmVWpVZ,cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,BOlluuSLL(gt1,gt2,gt3,gt4)           & 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengS2L2u(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MDpm,MDpm2,MFd,              & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,             & 
& MVZp,MVZp2,cplAhAhAh,cplAhAhhh,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhDpmcDpm,               & 
& cplAhhhhh,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmVWp,cplAhHpmVXp,         & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,               & 
...
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmVWp,cplhhHpmVXp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,       & 
& cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,              & 
& cplHpmVPVXp,cplHpmVWpVZ,cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,PSOlluuSLL(gt1,gt2,gt3,gt4)& 
...
gt3 = IndexArray4(i1,3) 
gt4 = IndexArray4(i1,4) 
Call CalculatePengV2L2u(gt1,gt2,gt3,gt4,.False.,MAh,MAh2,MDpm,MDpm2,MFd,              & 
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,             & 
& MVZp,MVZp2,cplAhAhAh,cplAhAhhh,cplAhcHpmcVWp,cplAhcHpmcVXp,cplAhDpmcDpm,               & 
& cplAhhhhh,cplAhhhVP,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmVWp,cplAhHpmVXp,         & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,               & 
...
& cplhhhhhh,cplhhHpmcHpm,cplhhHpmVWp,cplhhHpmVXp,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,       & 
& cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmVPVWp,              & 
& cplHpmVPVXp,cplHpmVWpVZ,cplHpmVWpVZp,cplHpmVXpVZ,cplHpmVXpVZp,PVOlluuSLL(gt1,gt2,gt3,gt4)& 
...
& cplcFeFv1HpmR,cplcFv1FecHpmL,cplcFv1FecHpmR,cplcFv1FeVWpL,cplcFv1FeVWpR,               & 
& cplFeFv1cHpmL,cplFeFv1cHpmR,cplhhhhhh,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,      & 
& cplhhVZVZp,BO4lSLL(gt1,gt2,gt3,gt4),BO4lSRR(gt1,gt2,gt3,gt4),BO4lSRL(gt1,gt2,gt3,gt4)  & 
...
& cplcFeFv1HpmR,cplcFv1FecHpmL,cplcFv1FecHpmR,cplcFv1FeVWpL,cplcFv1FeVWpR,               & 
& cplFeFv1cHpmL,cplFeFv1cHpmR,cplhhhhhh,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,      & 
& cplhhVZVZp,PSO4lSLL(gt1,gt2,gt3,gt4),PSO4lSRR(gt1,gt2,gt3,gt4),PSO4lSRL(gt1,gt2,gt3,gt4)& 
...
& cplcFeFv1HpmR,cplcFv1FecHpmL,cplcFv1FecHpmR,cplcFv1FeVWpL,cplcFv1FeVWpR,               & 
& cplFeFv1cHpmL,cplFeFv1cHpmR,cplhhhhhh,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,      & 
& cplhhVZVZp,PVO4lSLL(gt1,gt2,gt3,gt4),PVO4lSRR(gt1,gt2,gt3,gt4),PVO4lSRL(gt1,gt2,gt3,gt4)& 
...
& cplcFeFv1HpmR,cplcFv1FecHpmL,cplcFv1FecHpmR,cplcFv1FeVWpL,cplcFv1FeVWpR,               & 
& cplFeFv1cHpmL,cplFeFv1cHpmR,cplhhhhhh,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,      & 
& cplhhVZVZp,BO4lSLLcross(gt1,gt2,gt3,gt4),BO4lSRRcross(gt1,gt2,gt3,gt4),BO4lSRLcross(gt1,gt2,gt3,gt4)& 
...
& cplcFeFv1HpmR,cplcFv1FecHpmL,cplcFv1FecHpmR,cplcFv1FeVWpL,cplcFv1FeVWpR,               & 
& cplFeFv1cHpmL,cplFeFv1cHpmR,cplhhhhhh,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,      & 
& cplhhVZVZp,PSO4lSLLcross(gt1,gt2,gt3,gt4),PSO4lSRRcross(gt1,gt2,gt3,gt4)               & 
...
& cplcFeFv1HpmR,cplcFv1FecHpmL,cplcFv1FecHpmR,cplcFv1FeVWpL,cplcFv1FeVWpR,               & 
& cplFeFv1cHpmL,cplFeFv1cHpmR,cplhhhhhh,cplhhVPVZ,cplhhVPVZp,cplhhVZpVZp,cplhhVZVZ,      & 
& cplhhVZVZp,PVO4lSLLcross(gt1,gt2,gt3,gt4),PVO4lSRRcross(gt1,gt2,gt3,gt4)               & 
...
& MHpm2,MVWp,MVWp2,MVZ,MVZ2,MVZp,MVZp2,cplAhhhVP,cplcFecFv1HpmL,cplcFecFv1HpmR,          & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,               & 
& cplcFeFeVZL,cplcFeFeVZpL,cplcFeFeVZpR,cplcFeFeVZR,cplcFeFv1cVWpL,cplcFeFv1cVWpR,       & 
& cplcFeFv1HpmL,cplcFeFv1HpmR,cplcFv1FecHpmL,cplcFv1FecHpmR,cplcFv1FeVWpL,               & 
& cplcFv1FeVWpR,cplcFv1Fv1VPL,cplcFv1Fv1VPR,cplcHpmcVWpVP,cplcVWpVPVWp,cplFeFv1cHpmL,    & 
& cplFeFv1cHpmR,cplhhVPVZ,cplhhVPVZp,cplHpmcHpmVP,cplHpmVPVWp,OA2lSL(gt1,gt2)            & 
...
& MVWp,MVWp2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhhh,cplAhhhhh,cplAhhhVZ,cplAhhhVZp,               & 
& cplcFecFv1HpmL,cplcFecFv1HpmR,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,         & 
& cplcFeFeVZL,cplcFeFeVZpL,cplcFeFeVZpR,cplcFeFeVZR,cplcFeFv1cVWpL,cplcFeFv1cVWpR,       & 
& cplcFeFv1HpmL,cplcFeFv1HpmR,cplcFv1FecHpmL,cplcFv1FecHpmR,cplcFv1FeVWpL,               & 
& cplcFv1FeVWpR,cplFeFv1cHpmL,cplFeFv1cHpmR,cplhhcHpmcVWp,cplhhcVWpVWp,cplhhhhhh,        & 
& cplhhHpmcHpm,cplhhHpmVWp,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,OH2lSL(gt1,gt2,gt3)          & 
& ,OH2lSR(gt1,gt2,gt3))
...
& MVWp,MVWp2,MVZ,MVZ2,MVZp,MVZp2,cplAhhhVZ,cplcFecFv1HpmL,cplcFecFv1HpmR,cplcFeFeAhL,    & 
& cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZpL,cplcFeFeVZpR,             & 
& cplcFeFeVZR,cplcFeFv1cVWpL,cplcFeFv1cVWpR,cplcFeFv1HpmL,cplcFeFv1HpmR,cplcFv1FecHpmL,  & 
& cplcFv1FecHpmR,cplcFv1FeVWpL,cplcFv1FeVWpR,cplcFv1Fv1VZL,cplcFv1Fv1VZR,cplcHpmcVWpVZ,  & 
& cplcVWpVWpVZ,cplFeFv1cHpmL,cplFeFv1cHpmR,cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVZ,            & 
& cplHpmVWpVZ,OZ2lSL(gt1,gt2),OZ2lSR(gt1,gt2),OZ2lVL(gt1,gt2),OZ2lVR(gt1,gt2))
...
Call Gminus2(1,MAh,MAh2,MFe,MFe2,Mhh,Mhh2,MHpm,MHpm2,MVZp,MVZp2,cplcFeFeAhL,          & 
& cplcFeFeAhR,cplAhhhVP,cplFeFv1cHpmL,cplFeFv1cHpmR,cplcFeFehhL,cplcFeFehhR,             & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZpL,cplcFeFeVZpR,cplcFv1FecHpmL,cplcFv1FecHpmR,       & 
& cplcFeFv1HpmL,cplcFeFv1HpmR,cplcFv1Fv1VPL,cplcFv1Fv1VPR,cplHpmcHpmVP,cplcFecFv1HpmL,   & 
& cplcFecFv1HpmR,ae)

Call Gminus2(2,MAh,MAh2,MFe,MFe2,Mhh,Mhh2,MHpm,MHpm2,MVZp,MVZp2,cplcFeFeAhL,          & 
& cplcFeFeAhR,cplAhhhVP,cplFeFv1cHpmL,cplFeFv1cHpmR,cplcFeFehhL,cplcFeFehhR,             & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZpL,cplcFeFeVZpR,cplcFv1FecHpmL,cplcFv1FecHpmR,       & 
& cplcFeFv1HpmL,cplcFeFv1HpmR,cplcFv1Fv1VPL,cplcFv1Fv1VPR,cplHpmcHpmVP,cplcFecFv1HpmL,   & 
& cplcFecFv1HpmR,amu)

Call Gminus2(3,MAh,MAh2,MFe,MFe2,Mhh,Mhh2,MHpm,MHpm2,MVZp,MVZp2,cplcFeFeAhL,          & 
& cplcFeFeAhR,cplAhhhVP,cplFeFv1cHpmL,cplFeFv1cHpmR,cplcFeFehhL,cplcFeFehhR,             & 
& cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZpL,cplcFeFeVZpR,cplcFv1FecHpmL,cplcFv1FecHpmR,       & 
& cplcFeFv1HpmL,cplcFeFv1HpmR,cplcFv1Fv1VPL,cplcFv1Fv1VPR,cplHpmcHpmVP,cplcFecFv1HpmL,   & 
& cplcFecFv1HpmR,atau)
...
Call LeptonEDM(1,MAh,MAh2,MFe,MFe2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVZ,MVZ2,           & 
& MVZp,MVZp2,cplcFeFeAhL,cplcFeFeAhR,cplAhhhVP,cplFeFv1cHpmL,cplFeFv1cHpmR,              & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFv1FeVWpL,cplcFv1FeVWpR,           & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFeVZpL,cplcFeFeVZpR,cplcFv1FecHpmL,cplcFv1FecHpmR,       & 
& cplcFeFv1HpmL,cplcFeFv1HpmR,cplcFv1Fv1VPL,cplcFv1Fv1VPR,cplcFeFv1cVWpL,cplcFeFv1cVWpR, & 
& cplHpmcHpmVP,cplcFecFv1HpmL,cplcFecFv1HpmR,cplcVWpVPVWp,EDMe)

Call LeptonEDM(2,MAh,MAh2,MFe,MFe2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVZ,MVZ2,           & 
& MVZp,MVZp2,cplcFeFeAhL,cplcFeFeAhR,cplAhhhVP,cplFeFv1cHpmL,cplFeFv1cHpmR,              & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFv1FeVWpL,cplcFv1FeVWpR,           & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFeVZpL,cplcFeFeVZpR,cplcFv1FecHpmL,cplcFv1FecHpmR,       & 
& cplcFeFv1HpmL,cplcFeFv1HpmR,cplcFv1Fv1VPL,cplcFv1Fv1VPR,cplcFeFv1cVWpL,cplcFeFv1cVWpR, & 
& cplHpmcHpmVP,cplcFecFv1HpmL,cplcFecFv1HpmR,cplcVWpVPVWp,EDMmu)

Call LeptonEDM(3,MAh,MAh2,MFe,MFe2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVZ,MVZ2,           & 
& MVZp,MVZp2,cplcFeFeAhL,cplcFeFeAhR,cplAhhhVP,cplFeFv1cHpmL,cplFeFv1cHpmR,              & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFv1FeVWpL,cplcFv1FeVWpR,           & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFeVZpL,cplcFeFeVZpR,cplcFv1FecHpmL,cplcFv1FecHpmR,       & 
& cplcFeFv1HpmL,cplcFeFv1HpmR,cplcFv1Fv1VPL,cplcFv1Fv1VPR,cplcFeFv1cVWpL,cplcFeFv1cVWpR, & 
& cplHpmcHpmVP,cplcFecFv1HpmL,cplcFecFv1HpmR,cplcVWpVPVWp,EDMtau)
...
Call DeltaRho(MAh,MAh2,MDpm,MDpm2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,           & 
& MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhcVWpVWp,cplAhAhVZVZ,            & 
& cplAhcHpmcVWp,cplAhhhVZ,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucVWpL,cplcFdFucVWpR,           & 
& cplcFeFeVZL,cplcFeFeVZR,cplcFeFv1cVWpL,cplcFeFv1cVWpR,cplcFuFuVZL,cplcFuFuVZR,         & 
& cplcFv1Fv1VZL,cplcFv1Fv1VZR,cplcgAgWpcVWp,cplcgWCgAcVWp,cplcgWCgWCVZ,cplcgWCgZcVWp,    & 
& cplcgWCgZpcVWp,cplcgWpgWpVZ,cplcgXp1gXp1VZ,cplcgXp2gXp2VZ,cplcgZgWpcVWp,               & 
& cplcgZpgWpcVWp,cplcHpmcVWpVP,cplcHpmcVWpVZ,cplcHpmcVWpVZp,cplcVWpcVWpVWpVWp1,          & 
& cplcVWpcVWpVWpVWp2,cplcVWpcVWpVWpVWp3,cplcVWpcVXpVWpVXp1,cplcVWpcVXpVWpVXp2,           & 
& cplcVWpcVXpVWpVXp3,cplcVWpVPVPVWp1,cplcVWpVPVPVWp2,cplcVWpVPVPVWp3,cplcVWpVPVWp,       & 
& cplcVWpVWpVZ,cplcVWpVWpVZp,cplcVWpVWpVZpVZp1,cplcVWpVWpVZpVZp2,cplcVWpVWpVZpVZp3,      & 
& cplcVWpVWpVZVZ1,cplcVWpVWpVZVZ2,cplcVWpVWpVZVZ3,cplcVXpVXpVZ,cplcVXpVXpVZVZ1,          & 
& cplcVXpVXpVZVZ2,cplcVXpVXpVZVZ3,cplDpmcDpmcVWpVWp,cplDpmcDpmVZ,cplDpmcDpmVZVZ,         & 
& cplDpmcHpmcVWp,cplDpmcVWpVXp,cplhhcHpmcVWp,cplhhcVWpVWp,cplhhhhcVWpVWp,cplhhhhVZVZ,    & 
& cplhhVPVZ,cplhhVZVZ,cplhhVZVZp,cplHpmcHpmcVWpVWp,cplHpmcHpmVZ,cplHpmcHpmVZVZ,          & 
& cplHpmVWpVZ,cplHpmVXpVZ,dRho)

Call STUparameter(vSM,g1SM,g2SM,g3SM,YuSM,YdSM,YeSM,MAh,MAh2,MDpm,MDpm2,              & 
& MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWp,MVWp2,MVXp,MVXp2,MVZ,              & 
& MVZ2,MVZp,MVZp2,cplAhhhVP,cplDpmcDpmVP,cplcFdFdVPL,cplcFdFdVPR,cplcFeFeVPL,            & 
& cplcFeFeVPR,cplcFuFuVPL,cplcFuFuVPR,cplcFv1Fv1VPL,cplcFv1Fv1VPR,cplcgWpgWpVP,          & 
& cplcgWCgWCVP,cplcgXp1gXp1VP,cplcgXp2gXp2VP,cplhhVPVZ,cplhhVPVZp,cplHpmcHpmVP,          & 
& cplHpmVPVWp,cplHpmVPVXp,cplcVWpVPVWp,cplcVXpVPVXp,cplAhAhVPVP,cplDpmcDpmVPVP,          & 
& cplhhhhVPVP,cplHpmcHpmVPVP,cplcVWpVPVPVWp1,cplcVWpVPVPVWp2,cplcVWpVPVPVWp3,            & 
